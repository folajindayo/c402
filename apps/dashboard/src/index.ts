...
<main>
  ...
  <section class="panel" style="margin-top: 16px;">
    ...
    <table>
      <thead><tr><th>Source</th><th>Type</th><th>Agent</th><th>Value</th><th>Liquidation Value</th><th>Locked</th><th>Verifier</th></tr></thead>
  ...
  <section class="panel" style="margin-top: 16px;">
    <h2>Liquidations</h2>
    <table>
      <thead><tr><th>Advance</th><th>Lender</th><th>Collateral</th><th>Reserve</th><th>Shortfall</th></tr></thead>
      <tbody id="liquidations"><tr><td colspan="5">loading</td></tr></tbody>
    </table>
  </section>
  <section class="panel">
    <h2>c402 Credit</h2>
